    ...
    public class CaseViewModel : ObservableObject, INotifyDataErrorInfo, IDisposable
    {
                ...
                switch (columnName)
                {
                    case "ID":
                        if (IsInvalidId)
                        {
                            ...
                            //{
                            //    int lastIndexOf = prefix.LastIndexOf(IDSeparator);
                            ...
                            //    else
                            //    {
                            //        string abbrPrefix = prefix.Substring(0, lastIndexOf);
                            //        if (ID.StartsWith(abbrPrefix, StringComparison.OrdinalIgnoreCase) || ID.StartsWith(abbrPrefix + IDSeparator, StringComparison.OrdinalIgnoreCase))
                            //        {
                            //            foundValidPrefix = true;
                            //            break;
                            //        }
        ...
        public Core.Enums.EpiCaseClassification EpiCurveCaseCategory
        {
            get
            {
                ...
                if (EpiCaseDef == Core.Enums.EpiCaseClassification.Confirmed || EpiCaseDef == Core.Enums.EpiCaseClassification.Probable || EpiCaseDef == Core.Enums.EpiCaseClassification.Suspect)
                {
                    return EpiCaseDef;
                }
        ...
        public string OriginalID { get { return _OriginalID; } set { if (_OriginalID != value) { _OriginalID = value; RaisePropertyChanged("OriginalID"); } } }
        ...
        public string SymptomOtherNonHemorrhagicSpecify
        {
            ...
            set { if (_SymptomOtherNonHemorrhagicSpecify != value) { _SymptomOtherNonHemorrhagicSpecify = value; RaisePropertyChanged("SymptomOtherNonHemorrhagicSpecify"); } }
        }
        ...
        public string ContactStatus1 { get { return _ContactStatus1; } set { if (_ContactStatus1 != value) { _ContactStatus1 = value; RaisePropertyChanged("ContactStatus1");
        ...
        public string ContactStatus2 { get { return _ContactStatus2; } set { if (_ContactStatus2 != value) { _ContactStatus2 = value; RaisePropertyChanged("ContactStatus2");
        switch (_ContactStatus1)
        {
            case "1":
                break;
        ...
        public void LoadPartial()
        {
            ...
            Query selectQuery = db.CreateQuery("SELECT t.GlobalRecordId, ID, OrigID, Surname, OtherNames, Age, AgeUnit, Gender, HeadHouse, StatusReport, " +
                ...
                "DateDischargeHosp, FirstSaveTime, LastSaveTime " +
        ...
        public void LoadPartial(DataRow row)
        {
            ...
            {
                FirstSaveTime = DateTime.Parse(row["FirstSaveTime"].ToString());
            }

            if (!String.IsNullOrEmpty(row["LastSaveTime"].ToString()))
            {
                LastSaveTime = DateTime.Parse(row["LastSaveTime"].ToString());
            }
        }
        ...
        public void Load()
        {
            ...
            if (field1 != null && field2 != null && field3 != null && field4 != null && field5 != null && fieldLabSpecId != null)
            {
                ...
                Query labSelectQuery = db.CreateQuery("SELECT * " + LabForm.FromViewSQL + " WHERE FKEY = @GlobalRecordId ORDER BY [DateSampleCollected]");
        ...
        public void Save()
        {
            ...
            if (!exists)
            {
                ...
                Query keyQuery = db.CreateQuery("SELECT UniqueKey FROM " + CaseForm.TableName + " WHERE GlobalRecordId = @GlobalRecordId");
                keyQuery.Parameters.Add(new QueryParameter("@GlobalRecordId", DbType.String, RecordId));
                dt = db.Select(keyQuery);
                UniqueKey = Convert.ToInt32(dt.Rows[0][0]);
        ...
        public ICommand CancelEditModeCommand { get { return new RelayCommand(CancelEditModeCommandExecute, CanExecuteCancelCommand); } }
