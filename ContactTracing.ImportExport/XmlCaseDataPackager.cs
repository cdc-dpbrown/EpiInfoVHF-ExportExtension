...
namespace ContactTracing.ImportExport
{
    ...
    /// </summary>
    public class XmlCaseDataPackager
    {
        #region Events
        ...
        public XmlCaseDataPackager(View sourceForm, string packageName)
        {
        ...
        /// </summary>
        public Dictionary<string, List<string>> FieldsToNull { get; private set; }
        ...
        /// </summary>
        public Dictionary<string, RowFilters> Filters { get; private set; }

        /// <summary>
        /// Gets/sets the list of grid columns whose data should be erased during the packaging process
        /// </summary>
        public Dictionary<string, List<string>> GridColumnsToNull { get; private set; }
