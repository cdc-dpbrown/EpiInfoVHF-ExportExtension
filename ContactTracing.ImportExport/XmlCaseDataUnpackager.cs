...
namespace ContactTracing.ImportExport.ProjectPackagers
{
    /// <summary>
    /// A class used to import data from an Epi Info 7 VHF case data package (represented as Xml) into the specified VHF form and any of its descendant forms.
    /// </summary>
    /// <remarks>
    /// The ImportInfo object contains information about what was imported and can be accessed after the import 
    /// process has been completed.
    /// </remarks>
    public class XmlCaseDataUnpackager
    {
        #region Events
        ...
        public XmlCaseDataUnpackager(View destinationForm, XmlDocument xmlDataPackage)
        {
                    ...
                    foreach (XmlNode fieldInfoNode in fieldMetaDataNode.ChildNodes)
                    {
                        ...
                        if (form.Fields.Contains(fieldName))
                        {
                            ...
                            if (!fieldType.Equals(t, StringComparison.OrdinalIgnoreCase))
                            {
                                ...
                                {
                                    // Text, CommentLegal, LegalValues, Codes
        ...
        protected virtual void ImportRecordsToPageTables(View form, List<PackageFieldData> records, Dictionary<string, bool> destinationGuids)
        {
            ...
            if (destinationGuids == null) { throw new ArgumentNullException("destinationGuids"); }
            #endregion // Input Validation
                ...
                )))
            {
                ...
                switch (dataField.FieldType)
                {
                    ...
                    case MetaFieldType.Time:
                        ...
                        return new QueryParameter("@" + fieldName, DbType.DateTime2, dt);
        ...
        protected object FormatFieldData(string fieldName, object value)
        {
            ...
            {
                throw new ArgumentNullException("value cannot be null in FormatFieldData");
            }
        }
